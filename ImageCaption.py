...
gui = tkinter.Tk()
gui.title("IMAGE CAPTION GENERATION USING DEEP LEARNING") 
...
font = ('times', 16, 'bold')
title = Label(gui, text='IMAGE CAPTIONING USING DEEP LEARNING')
title.config(bg='firebrick4', fg='goldenrod2')  
